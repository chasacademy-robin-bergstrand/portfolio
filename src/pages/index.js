            ...
            <main className="flex min-h-screen flex-col py-24">
                ...
                <div className="max-w-4xl mx-auto mt-16">
                    <p className="mb-4 text-center">
                        ...
                        at Chas Academy, Stockholm. <br /> Looking for an
                        internship for 24 weeks from{" "}
                        <span className="text-blue-400">November</span> forward.
                    </p>
                    <p className="text-center">
                        I have always had a large interest for tech ever since I
                        was young and enjoy learning new technologies and tools.
                        <br />I Shouldn't have any issues learning whatever is
